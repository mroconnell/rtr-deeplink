...
def _is_empty_page_condition():
    ...
    `agenda_link` is deliberately NOT counted as content (2026-08-25, WO-58
...
async def get_thin_page_audit(slugs: Optional[set[str]] = None) -> dict:
    ...
    Built 2026-08-25 (WO-58) to size the Soft 404 fix in the same pass
