...
- **[HUMAN] `[LOGIN]` Render "HTTP health check failed" on
  `rtr-deeplink-archive` has recurred twice — 2026-08-19 13:17:28 UTC
  and 2026-08-20 21:38:36 UTC, ~32h apart — promoted from
  `CLAUDE_INBOX_TRIAGE.md`.** Distinct from the already-diagnosed
  2026-08-17 instability cluster below — a plain health-check timeout
