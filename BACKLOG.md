...
- **History:** [BACKLOG_DONE.md](BACKLOG_DONE.md) WO-919 (the check), WO-921 (the Sliq adapter), WO-922 (the Invintus walker); PR #1260 (the queue lines); WO-931 (this rewrite); WO-1006 (2026-09-22, sibling hosts + OK Senate/WV House + five new tenants).
