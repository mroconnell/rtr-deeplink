...
Builds on `wo273_recon.py` (imported as a module below, not rewritten --
every DNS/archive/robots/sitemap/Wayback/Common-Crawl helper it defines
is reused verbatim). This script adds the pieces WO-273's own writeup
flagged as missing:
