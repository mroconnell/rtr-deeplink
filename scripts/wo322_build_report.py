#!/usr/bin/env python3
"""WO-322: build `research/wo322_report.csv`, one row per government,
...
Usage:
    .venv/bin/python scripts/wo322_build_report.py
"""
...
REPORT_CSV = RESEARCH_DIR / "wo322_report.csv"
...
def main() -> None:
    ...
    for domain in sorted(domains):
        ...
        elif tgt.get("error", "") == "youtube-lead-skipped":
            outcome = "youtube-lead-skipped"
