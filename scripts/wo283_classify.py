"""WO-283 (2026-09-12): passive discovery v2 at full scale, phase 2 -- offline
classification over phase 1's raw recon file (`wo283_recon.jsonl`).
...
Output: `research/wo283_classified.csv`, one row per government, with a
...
Usage (from the rtr-deeplink repo root, shared venv):
    DATABASE_URL="sqlite+aiosqlite:////tmp/wo283_classify_scratch.db" \\
        .venv/bin/python scripts/wo283_classify.py
