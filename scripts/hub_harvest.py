...
# WO-1070 addendum (Ryan, 2026-09-25): a hand-check of real "confident"
...
_EXPECTED_GOV_TYPES_BY_BODY_TYPE: Dict[str, frozenset] = {
    ...
    # WO-1070 addendum: real Horseheads, NY case -- an explicit "Town of
...
_JOINT_OR_SPECIAL_BODY_RE = re.compile(
    ...
    # WO-1070 addendum (Ryan, 2026-09-25): a police services board is a
...
def _enforce_type_agreement(
    ...
    """WO-1070 addendum: `body_type_hint` (normalized via
...
def _match_place_text(
    ...
    *,
    ...
    WO-1070 addendum: whatever match is finally chosen, if `body_type_hint`
