"""WO-320 (2026-09-12): passive discovery v2 at full scale, phase 1 --
...
reach, with one addition:
  ...
  - **govAccess/Akamai block.** This machine's address is blocked
    ...
    a separate `wo320_govaccess_deferred.csv` sidecar for a later run
    from a different address, once the conductor lifts the block.

Usage (from the rtr-deeplink repo root, shared venv):
    .venv/bin/python scripts/wo320_recon.py --limit 50 --concurrency 32
    .venv/bin/python scripts/wo320_recon.py --concurrency 32
    .venv/bin/python scripts/wo320_recon.py --finalize
"""
...
POPULATION_CSV = RESEARCH_DIR / "passive_neither_1-us-muni-twp-5k-plus.csv"
...
SCRATCH_DIR = Path(
    ...
    "/1d27de13-eb07-451a-a07a-bb18900b5618/scratchpad/agents/a11dad5d8d1a97ec6/wo320_homepages"
)
...
# WO-320: this machine's address is blocked (HTTP 403 AkamaiGHost) on every
