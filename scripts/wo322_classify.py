"""WO-322 (2026-09-12): passive discovery v2 at full scale, phase 2 -- offline
classification over phase 1's raw recon file (`wo322_recon.jsonl`).
...
Output: `research/wo322_classified.csv`, one row per government, with a
...
Usage (from the rtr-deeplink repo root, shared venv):
    DATABASE_URL="sqlite+aiosqlite:////tmp/wo322_classify_scratch.db" \\
        .venv/bin/python scripts/wo322_classify.py
