...
path, checked directly -- see `wo325_split_population.py` in this WO's
...
from WO-283:
  ...
  - **govAccess/Akamai block.** This machine's address is blocked
    ...
    a separate `wo325_govaccess_deferred.csv` sidecar for a later run
    from a different address, once the conductor lifts the block.

Usage (from the rtr-deeplink repo root, shared venv):
    .venv/bin/python scripts/wo325_recon.py --limit 50 --concurrency 32
    .venv/bin/python scripts/wo325_recon.py --concurrency 32
    .venv/bin/python scripts/wo325_recon.py --finalize
"""
...
RECON_JSONL = RESEARCH_DIR / "wo325_recon.jsonl"
GOVACCESS_DEFERRED_CSV = RESEARCH_DIR / "wo325_govaccess_deferred.csv"

SCRATCH_DIR = Path(
    "/private/tmp/claude-501/-Users-mroconnell-Documents-rtr-deeplink--claude-worktrees-platform-detection-backfill-c9742a"
    "/1d27de13-eb07-451a-a07a-bb18900b5618/scratchpad/agents/a07ada8e1a0063e1b/wo325/wo325_homepages"
)
