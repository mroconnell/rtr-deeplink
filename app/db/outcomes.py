...
def classify_outcome(row: MeetingResolution) -> str:
    ...
    resolve() raised. A resolve that returns 200 with a video but no
    transcript is not a real success -- this is what lets the report
    tell "the adapter is broken" apart from "the adapter half-worked."
    """
