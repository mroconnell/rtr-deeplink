...
class MeetingResolution(Base):
    ...
    input_url_normalized: Mapped[str] = mapped_column(
    ...
    transcript_found: Mapped[bool] = mapped_column(
    ...
    archive_pushed_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    archive_push_attempts: Mapped[int] = mapped_column(
